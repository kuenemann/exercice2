...
// - Faire s'afficher la constante "addressFull" dans la console du navigateur.
 const address:string="120chemindemoncul"
 const ZipCode:number="0796059609"
 function exercice1{
...
prendre le ticket du client
le passer dans la machine,verifier si il est gagnant 
lui dire qu'il a perdu et lui proposer de rejouer 
...
// - Écrivez cette algortihme en pseudo code à l'aide des commentaires Javascript.
dire bonjour au client     
passer tous les acrticles
calculer le prix hors taxes le noter 
rajouter 20% de tva 
et lui annoncer la bonne nouvelle du paiement
...
// - Faire s'afficher la concaténation de ces deux variables dans la console du navigateur.
    ...
    const lastName:string="kuenemann"
